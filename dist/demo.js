...
async function main() {
    ...
    const agents = [
        {
            ...
            auditScore: 0,
            accountAgeDays: 15,
            verificationTier: schema_1.VerificationTier.VERIFIED,
        ...
        },
        {
            ...
            auditScore: 0,
            accountAgeDays: 12,
            verificationTier: schema_1.VerificationTier.BASIC,
    ...
    for (const agent of agents) {
        console.log(`\n--- ${agent.agentName} ---`);
        const attestation = (0, trust_engine_1.calculateTrustScore)(agent);
